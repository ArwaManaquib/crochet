  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <Link
          href="/"
          className="flex items-center gap-3 text-primary-400 group"
        >
          <motion.div
        ...
        >
          {navItems.map((item, index) => (
            ...
            >
              <Link
                href={item.href}
                className="block py-2 text-primary-400 text-sm font-medium hover:text-primary-200 transition-colors"
